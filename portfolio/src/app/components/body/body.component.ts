...
import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls.js' // Adjust path based on your directory structure
...
export class BodyComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.initThreeJS();
    this.animate();
    window.addEventListener('resize', this.updateThing);
  }
  ...
  private initThreeJS() {
    ...
    loader.load(
      'assets/models/tibo/thibault.gltf',  // Updated path
      (gltf) => {
